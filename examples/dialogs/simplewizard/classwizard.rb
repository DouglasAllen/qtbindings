...
class ClassWizard < SimpleWizard
  ...
  def accept
    ...
    block += ' : public ' + baseClass unless baseClass.empty?
    block += "\n"
    block += "{\n"
    ...
    unless headerFile.open(Qt::File::WriteOnly | Qt::File::Text)
    ...
    unless implementationFile.open(Qt::File::WriteOnly | Qt::File::Text)
      Qt::MessageBox.warning(self, tr('Simple Wizard'),
                             tr("Cannot write file %s:\n%s" %
