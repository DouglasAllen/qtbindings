...
class Dialog < Qt::Dialog
  ...
  def setInteger
    ...
    @integerLabel.text = tr('%d%' % i) if ok
  end

  def setDouble
    ok = Qt::Boolean.new
    d = Qt::InputDialog.getDouble(self, tr('Qt::InputDialog.getDouble()'),
                                  tr('Amount:'), 37.56, -10_000, 10_000, 2, ok)
    @doubleLabel.text = '$%f' % d if ok
  end
  ...
  def setItem
    ...
    @itemLabel.text = item if ok && !item.nil?
  end
  ...
  def setText
    ...
    @textLabel.text = text if ok && !text.nil?
  end
  ...
  def setExistingDirectory
    ...
    @directoryLabel.text = directory unless directory.nil?
  end
  ...
  def setOpenFileName
    ...
    @openFileNameLabel.text = fileName unless fileName.nil?
  end
  ...
  def setSaveFileName
    fileName = Qt::FileDialog.getSaveFileName(self,
                                              ...
                                              tr('All Files (*);;Text Files (*.txt)'))
    @saveFileNameLabel.text = fileName unless fileName.nil?
  end
  ...
  def criticalMessage
    ...
    @criticalLabel.text = if reply == Qt::MessageBox::Abort
                            tr('Abort')
  ...
  def questionMessage
    ...
    @questionLabel.text = if reply == Qt::MessageBox::Yes
                            tr('Yes')
